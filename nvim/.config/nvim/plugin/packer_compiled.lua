...
_G.packer_plugins = {
  ...
  ["crates.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/crates.nvim",
  ...
  ["leap.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["nvim-ufo"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nvim-ufo",
  ...
  ["promise-async"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/promise-async",
